...
a = Analysis(
    [r'D:\menusifu\PythonProject\rc\pos_tool_new\pos_tool_new\main_refactor.py'],
    pathex=[r'D:\menusifu\PythonProject\rc\pos_tool_new'],
    binaries=[],
    datas=[
        ('UI/app.ico', 'UI'),
        ('UI/loading.gif', 'UI'),
        ('version_info/version_info.html', 'version_info'),
    ],
    hiddenimports=[
        ...
        'pos_tool_new.lan_chat.lan_chat_window',
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
